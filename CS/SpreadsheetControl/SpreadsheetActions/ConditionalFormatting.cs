...
namespace ConditionalFormatting_Examples {
    class ConditionalFormatting {
        ...
        public static Action<IWorkbook> AddComplexRangeConditionalFormattingAction = AddComplexRangeConditionalFormatting;
        #endregion
        ...
        static void AddComplexRangeConditionalFormatting(IWorkbook workbook)
        {
            ...
            try
            {
                ...
                Range complexRange = worksheet.Range.Union(worksheet["G3:G6"], worksheet["G9:G12"]);
                ...
                // Add an explanation to the created rule.
                Range ruleExplanation = worksheet.Range["B15"];
