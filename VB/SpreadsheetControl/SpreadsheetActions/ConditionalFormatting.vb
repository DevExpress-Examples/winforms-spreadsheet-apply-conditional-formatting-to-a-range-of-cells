...
Namespace ConditionalFormatting_Examples
	Friend Class ConditionalFormatting
        ...
        Public Shared AddComplexRangeConditionalFormattingAction As Action(Of IWorkbook) = AddressOf AddComplexRangeConditionalFormatting
		#End Region
...
'			#End Region ' #IconSetConditionalFormatting
        ...
        Private Shared Sub AddComplexRangeConditionalFormatting(ByVal workbook As IWorkbook)
            workbook.Calculate()
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets("cfReport")
                workbook.Worksheets.ActiveWorksheet = worksheet
                '				#Region "#ComplexRangeConditionalFormatting"
                ' Create a union range to which the rule will be applied.
                Dim complexRange As Range = worksheet.Range.Union(worksheet("G3:G6"), worksheet("G9:G12"))
                ...
                '				#End Region ' #ComplexRangeConditionalFormatting
                ' Add an explanation to the created rule.
                Dim ruleExplanation As Range = worksheet.Range("B15")
